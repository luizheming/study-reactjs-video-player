...
export const Container = styled.div`
	...
	background: none;
	border: ${(props) => (props.active ? props.theme.borderItemActive : 'none')};
	font-size: 1.3em;
	...
	::before {
		...
		width: 10px;
		min-height: 10px;
		background: ${(props => props.theme.playedCircleColor)};
		border-radius: 50px;
		position: absolute;
		left: 0;
		top: 20px;
	...
	.wbn-player__video-nr {
		...
		max-width: 30px;
		padding-right: 20px;
		border-right: 2px solid ${(props) => props.theme.numberBorderColor};
	}
